(function(){
  ...
  function buildSteps(){
    ...
    steps.appendChild(h('<div id="wfq-step-4" class="wfq-step" style="display:none;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 4px 6px -1px rgb(0 0 0 / 0.1);margin-bottom:16px"><h2 style="font-size:1.5rem;font-weight:600;margin:0 0 8px;color:#111827">How long have you been employed?</h2><p style="color:#6b7280;margin:0 0 16px">This affects your potential compensation</p><div id="wfq-employment" style="display:flex;flex-direction:column;gap:10px"></div><div style="display:flex;justify-content:space-between;margin-top:24px"><button class="wfq-nav-btn wfq-back-btn" data-target-step="3" style="padding:10px 20px;border-radius:8px;border:1px solid #e5e7eb;background:#fff;cursor:pointer">← Back</button><button class="wfq-nav-btn wfq-continue-btn" data-target-step="5" style="padding:10px 20px;border-radius:8px;border:1px solid #3b82f6;background:#3b82f6;color:#fff;cursor:pointer">Continue →</button></div></div>'));
    steps.appendChild(h('<div id="wfq-step-5" class="wfq-step" style="display:none;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 4px 6px -1px rgb(0 0 0 / 0.1);margin-bottom:16px"><h2 style="font-size:1.5rem;font-weight:600;margin:0 0 8px;color:#111827">Tell Us More About Your Situation</h2><p style="color:#6b7280;margin:0 0 16px">We\'ll ask specific questions based on your selections</p><div id="wfq-conditional"></div><div style="display:flex;justify-content:space-between;margin-top:24px"><button class="wfq-nav-btn wfq-back-btn" data-target-step="4" style="padding:10px 20px;border-radius:8px;border:1px solid #e5e7eb;background:#fff;cursor:pointer">← Back</button><button class="wfq-nav-btn wfq-continue-btn" data-target-step="6" style="padding:10px 20px;border-radius:8px;border:1px solid #3b82f6;background:#3b82f6;color:#fff;cursor:pointer">Continue →</button></div></div>'));
    ...
    document.addEventListener('click',function(e){
      ...
      if(btn && btn.dataset && btn.dataset.val){
        ...
        if(state.step===1){
          ...
          // Handle conditional question buttons in step 5
          if(!state.answers['step_5']) state.answers['step_5'] = [];
          if(!state.answers['step_5'].includes(val)) {
